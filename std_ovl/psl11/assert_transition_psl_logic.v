...
//This file is included in assert_transition.vlib
...
`ifdef OVL_COVER_ON
 generate
  if (coverage_level != `OVL_COVER_NONE)
   begin: cover_checks
              assert_transition_cover #( .width (width) )
...
module assert_transition_assert (clk, reset_n, start_state, next_state, test_expr);
       parameter width = 8;
       input clk, reset_n; 
...
module assert_transition_assume (clk, reset_n, start_state, next_state, test_expr);
       parameter width = 8;
       input clk, reset_n; 
       input [width-1:0] test_expr, start_state, next_state;
endmodule
