...
//This file is included in assert_decrement.vlib
...
module assert_decrement_assert (clk, reset_n, test_expr);
       parameter width = 8;
       parameter value = 1;
       input clk, reset_n;
...
module assert_decrement_assume (clk, reset_n, test_expr);
       parameter width = 8;
       parameter value = 1;
       input clk, reset_n;
       input [width-1:0] test_expr;
