...
assign	assertion_shengyushen=(txd_sel==`PCS_TX_GMII_DATA) && 
	(link_up_loc==1'b1) && 
	(jitter_study_pci==2'b00) && 
//	(tx_enc_ctrl_sel==`PCS_ENC_DATA || (txd==8'h00  && (tx_enc_ctrl_sel==`PCS_ENC_K285 /*|| tx_enc_ctrl_sel==`PCS_ENC_SOP || tx_enc_ctrl_sel==`PCS_ENC_T_CHAR || tx_enc_ctrl_sel==`PCS_ENC_R_CHAR || tx_enc_ctrl_sel==`PCS_ENC_H_CHAR*/) )) && 
//	(txd==8'h00  && (tx_enc_ctrl_sel==`PCS_ENC_K285 || tx_enc_ctrl_sel==`PCS_ENC_SOP || tx_enc_ctrl_sel==`PCS_ENC_T_CHAR || tx_enc_ctrl_sel==`PCS_ENC_R_CHAR || tx_enc_ctrl_sel==`PCS_ENC_H_CHAR) ) && 
//	(tx_enc_ctrl_sel==`PCS_ENC_K285 || tx_enc_ctrl_sel==`PCS_ENC_SOP || tx_enc_ctrl_sel==`PCS_ENC_T_CHAR || tx_enc_ctrl_sel==`PCS_ENC_R_CHAR || tx_enc_ctrl_sel==`PCS_ENC_H_CHAR)  && 
//	(tx_enc_ctrl_sel==`PCS_ENC_DATA || (txd==8'h00  && tx_enc_ctrl_sel==`PCS_ENC_SOP)) && 
//	(txd==8'h00  && (tx_enc_ctrl_sel==`PCS_ENC_SOP || tx_enc_ctrl_sel==`PCS_ENC_K285) ) && 
