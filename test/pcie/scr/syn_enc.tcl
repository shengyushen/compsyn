...
set my_lib_path "  \
			~/compsyn/lib \
      ~/compsyn_ips/pcie/src/verilog \
"
set filelist "~/compsyn_ips/pcie/src/verilog/filelist.v"
set top_design PCIEXP_TX
...
current_design ${top_design}
set_ideal_network [get_ports PCLK250]
set maxD 8
create_clock -name PCLK250 -period ${maxD} -waveform [list 0.0 [expr ${maxD}/2.0]] [ get_ports PCLK250]
