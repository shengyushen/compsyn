...
remove_attribute [list ssy/AN2AI] dont_use
remove_attribute [list ssy/AN2AIBI] dont_use
remove_attribute [list ssy/OR2] dont_use
remove_attribute [list ssy/OR2AI] dont_use
remove_attribute [list ssy/OR2AIBI] dont_use
...
write -f verilog -o dc_synres_aig.v 
report_area > report_area_aig
