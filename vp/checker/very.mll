...
rule veriloglex  = parse
  ...
  | eof										{ 
	...
	| "{"		{LBRACE(Lexing.lexeme_start_p lexbuf, Lexing.lexeme_end_p lexbuf, Lexing.lexeme lexbuf)}
	| "}"		{RBRACE(Lexing.lexeme_start_p lexbuf, Lexing.lexeme_end_p lexbuf, Lexing.lexeme lexbuf)}
