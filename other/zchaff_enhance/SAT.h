...
int SAT_Solve_ssy 	(SAT_Manager 	mng,int clgrp_ext,int ** result_ptr_ptr,int * result_size_ptr,int totry);
int SAT_Solve_ssy_unsat 	(SAT_Manager 	mng,int clgrp_ext,int ** result_ptr_ptr,int * result_size_ptr,int totry);
//enum SAT_StatusT
